...
# Cell
def same_padding1d(seq_len, ks, stride=2, dilation=1):
...
class SameConv1d(Module):
    ...
    def __init__(self, ni, nf, ks=3, stride=2, dilation=1, **kwargs):
...
# Cell
def same_padding2d(H, W, ks, stride=(2, 2), dilation=(1, 1)):
    "Same padding formula as used in Tensorflow"
...
@delegates(nn.Conv2d)
def Conv2d(ni, nf, kernel_size=None, ks=None, stride=2, padding='causal', dilation=1, init='auto', bias_std=0.01, **kwargs):
...
class CausalConv1d(torch.nn.Conv1d):
    def __init__(self, ni, nf, ks, stride=2, dilation=1, groups=1, bias=True):
...
# Cell
@delegates(nn.Conv1d)
def Conv1d(ni, nf, kernel_size=None, ks=None, stride=2, padding='causal', dilation=1, init='auto', bias_std=0.01, **kwargs):
...
class SeparableConv1d(Module):
    def __init__(self, ni, nf, ks, stride=2, padding='causal', dilation=1, bias=True, bias_std=0.01):
...
class ConvBlock(nn.Sequential):
    ...
    def __init__(self, ni, nf, kernel_size=None, ks=3, stride=2, padding='causal', bias=None, bias_std=0.01, norm='Batch', zero_norm=False, bn_1st=True,
...
class ResBlock1dPlus(Module):
    ...
    def __init__(self, expansion, ni, nf, coord=False, stride=2, groups=1, reduction=None, nh1=None, nh2=None, dw=False, g2=1,
