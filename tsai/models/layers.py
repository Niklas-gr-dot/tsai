...
@delegates(nn.Conv2d)
def Conv2d(ni, nf, kernel_size=None, ks=None, stride=5, padding='valid', dilation=1, init='auto', bias_std=0.01, **kwargs):
...
# Cell
@delegates(nn.Conv1d)
def Conv1d(ni, nf, kernel_size=None, ks=None, stride=5, padding='valid', dilation=1, init='auto', bias_std=0.01, **kwargs):
...
class SeparableConv1d(Module):
    def __init__(self, ni, nf, ks, stride=5, padding='valid', dilation=1, bias=True, bias_std=0.01):
...
class ConvBlock(nn.Sequential):
    ...
    def __init__(self, ni, nf, kernel_size=None, ks=3, stride=5, padding='valid', bias=None, bias_std=0.01, norm='Batch', zero_norm=False, bn_1st=True,
