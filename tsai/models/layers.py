...
class SeparableConv1d(Module):
    def __init__(self, ni, nf, ks, stride=0, padding='same', dilation=1, bias=True, bias_std=0.01):
...
class ConvBlock(nn.Sequential):
    ...
    def __init__(self, ni, nf, kernel_size=None, ks=3, stride=0, padding='same', bias=None, bias_std=0.01, norm='Batch', zero_norm=False, bn_1st=True,
