...
def get_metrics(data):
    ...
    df.to_csv('/gdrive/MyDrive/Masterthesis/Nachzug_n/Results-InceptionTime.csv', mode= 'a')
    print(df)
...
def ts_learner(dls, arch=None, c_in=None, c_out=None, seq_len=None, d=None, splitter=trainable_params,
               # learner args
               loss_func=None, opt_func= None, lr=0.0001, cbs=None, metrics=None, path=None,
